...
public class AppliancePowerTVR2A6Thread extends Thread
{
	private int TVR2A6Power = 0;
	public AppliancePowerTVR2A6Thread()
	{
	}
	...
	public void run()
	{
		while(true){
			...
			try {
				...
				socket = ss.accept();
				System.out.println("Entered AppliancePowerTVR2A6Thread :-)");	
				...
				try
				{
					...
					System.out.println("AppliancePowerTVR2A6Thread::::: TV R2A6 Power:"+TVR2A6Power);
				}
