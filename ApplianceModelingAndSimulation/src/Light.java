...
public class Light extends ClockDomain{
	...
	private int tutu__1188620226;
	private int tutu__392303448;
	private int tutu__1190928719;
	private int tutu__2049330585;
	private int S503 = 1;
	private int S269 = 1;
	private int S501 = 1;
	private int S271 = 1;
	...
	private int[] tdone = new int[13];
		public void thread1233251098(int [] tdone, int [] ends){
          if(tdone[6] != 1){
            switch(S501){
              case 0 : 
              active[6]=0;
...
if(appliancePowerLight_o.get_preempted()){
                                        tutu__392303448 = 0;
                                        tutu__392303448 = appliancePowerLight_o.get_preempted() ? appliancePowerLight_o.refresh() : 0;
                    S278=1;
active[6]=1;
                    ends[6]=1;
tdone[6]=1;
...
if(appliancePowerLight_o.get_w_s() == appliancePowerLight_o.get_w_r()){
                                            tutu__1188620226 = 0;
                                            tutu__1188620226 = appliancePowerLight_o.get_w_s();
                                            tutu__1188620226++;
                                            appliancePowerLight_o.set_w_s(tutu__1188620226);
...
tdone[6]=1;
                ...
                switch(S278){
                  ...
                  if(appliancePowerLight_o.get_preempted()){
                                        tutu__2049330585 = 0;
                                        tutu__2049330585 = appliancePowerLight_o.get_preempted() ? appliancePowerLight_o.refresh() : 0;
                    S278=1;
active[6]=1;
                    ends[6]=1;
tdone[6]=1;
                    ...
                    switch(S273){
                      ...
                      if(appliancePowerLight_o.get_w_s() == appliancePowerLight_o.get_w_r()){
                                                tutu__1190928719 = 0;
                                                tutu__1190928719 = appliancePowerLight_o.get_w_s();
                                                tutu__1190928719++;
                                                appliancePowerLight_o.set_w_s(tutu__1190928719);
                                                appliancePowerLight_o.set_value(new Integer(power_thread_6));
                        S273=1;
if(appliancePowerLight_o.get_w_s() == appliancePowerLight_o.get_w_r()){
                                                    ends[6]=2;
...
public void thread1149760587(int [] tdone, int [] ends){
          if(tdone[5] != 1){
            switch(S269){
              case 0 : 
              active[5]=0;
...
public void thread1152069080(int [] tdone, int [] ends){
          if(tdone[6] != 1){
            S501=1;
S271=0;
active[6]=1;
...
public void thread1153223327(int [] tdone, int [] ends){
          if(tdone[5] != 1){
            S269=1;
if(onSignal.getprestatus()){
                            System.out.println("Light ON signal received");
...
RUN: while(true){
          ...
          thread1153223327(tdone,ends);
          thread1152069080(tdone,ends);
          int biggest1150145336 = 0;
          if(ends[5]>=biggest1150145336){
            biggest1150145336=ends[5];
}
          if(ends[6]>=biggest1150145336){
            biggest1150145336=ends[6];
}
          if(biggest1150145336 == 1){
            active[4]=1;
            ends[4]=1;
            break RUN;
            }
                    case 2 : 
                    powerReceive_4.setClear();
          thread1149760587(tdone,ends);
          thread1233251098(tdone,ends);
          int biggest1234020596 = 0;
          if(ends[5]>=biggest1234020596){
            biggest1234020596=ends[5];
}
          if(ends[6]>=biggest1234020596){
            biggest1234020596=ends[6];
}
          if(biggest1234020596 == 1){
            active[4]=1;
            ends[4]=1;
            break RUN;
            }
          //FINXME code
if(biggest1234020596 == 0){
            S503=0;
active[4]=0;
            ends[4]=0;
S503=0;
