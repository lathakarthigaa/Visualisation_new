...
public class HeaterR3A9 extends ClockDomain{
	...
	private int tutu__840603601;
	private int tutu__1110927416;
	private int tutu__924478861;
	private int tutu__396505489;
	private int S2267 = 1;
	private int S2033 = 1;
	private int S2265 = 1;
	private int S2035 = 1;
	...
	private int[] tdone = new int[73];
		public void thread63171565(int [] tdone, int [] ends){
          if(tdone[27] != 1){
            switch(S2265){
              case 0 : 
              active[27]=0;
...
if(appliancePowerHeaterR3A9_o.get_preempted()){
                                        tutu__1110927416 = 0;
                                        tutu__1110927416 = appliancePowerHeaterR3A9_o.get_preempted() ? appliancePowerHeaterR3A9_o.refresh() : 0;
                    S2042=1;
active[27]=1;
                    ends[27]=1;
tdone[27]=1;
...
if(appliancePowerHeaterR3A9_o.get_w_s() == appliancePowerHeaterR3A9_o.get_w_r()){
                                            tutu__840603601 = 0;
                                            tutu__840603601 = appliancePowerHeaterR3A9_o.get_w_s();
                                            tutu__840603601++;
                                            appliancePowerHeaterR3A9_o.set_w_s(tutu__840603601);
...
tdone[27]=1;
                ...
                switch(S2042){
                  ...
                  if(appliancePowerHeaterR3A9_o.get_preempted()){
                                        tutu__396505489 = 0;
                                        tutu__396505489 = appliancePowerHeaterR3A9_o.get_preempted() ? appliancePowerHeaterR3A9_o.refresh() : 0;
                    S2042=1;
active[27]=1;
                    ends[27]=1;
tdone[27]=1;
                    ...
                    switch(S2037){
                      ...
                      if(appliancePowerHeaterR3A9_o.get_w_s() == appliancePowerHeaterR3A9_o.get_w_r()){
                                                tutu__924478861 = 0;
                                                tutu__924478861 = appliancePowerHeaterR3A9_o.get_w_s();
                                                tutu__924478861++;
                                                appliancePowerHeaterR3A9_o.set_w_s(tutu__924478861);
                                                appliancePowerHeaterR3A9_o.set_value(new Integer(power_thread_27));
                        S2037=1;
if(appliancePowerHeaterR3A9_o.get_w_s() == appliancePowerHeaterR3A9_o.get_w_r()){
                                                    ends[27]=2;
...
public void thread64325812(int [] tdone, int [] ends){
          if(tdone[26] != 1){
            switch(S2033){
              case 0 : 
              active[26]=0;
...
public void thread54322341(int [] tdone, int [] ends){
          if(tdone[27] != 1){
            S2265=1;
S2035=0;
active[27]=1;
...
public void thread57015583(int [] tdone, int [] ends){
          if(tdone[26] != 1){
            S2033=1;
if(onSignal.getprestatus()){
                            System.out.println("Heater ON signal received");
...
RUN: while(true){
          ...
          thread57015583(tdone,ends);
          thread54322341(tdone,ends);
          int biggest53937592 = 0;
          if(ends[26]>=biggest53937592){
            biggest53937592=ends[26];
}
          if(ends[27]>=biggest53937592){
            biggest53937592=ends[27];
}
          if(biggest53937592 == 1){
            active[25]=1;
            ends[25]=1;
            break RUN;
            }
                    case 2 : 
                    powerReceive_25.setClear();
          thread64325812(tdone,ends);
          thread63171565(tdone,ends);
          int biggest60863072 = 0;
          if(ends[26]>=biggest60863072){
            biggest60863072=ends[26];
}
          if(ends[27]>=biggest60863072){
            biggest60863072=ends[27];
}
          if(biggest60863072 == 1){
            active[25]=1;
            ends[25]=1;
            break RUN;
            }
          //FINXME code
if(biggest60863072 == 0){
            S2267=0;
active[25]=0;
            ends[25]=0;
S2267=0;
